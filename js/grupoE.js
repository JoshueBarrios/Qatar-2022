...
botonDeCargaE.addEventListener("click", function () {
  ...
  espana.golesFavor =
    espana.golesFavor +
    parseInt(goles49.value) +
    parseInt(goles53.value) +
    parseInt(goles57.value);
  espana.golesContra =
    espana.golesContra +
    parseInt(goles50.value) +
    parseInt(goles54.value) +
    parseInt(goles58.value);

  costaRica.golesFavor =
    costaRica.golesFavor +
    parseInt(goles50.value) +
    parseInt(goles55.value) +
    parseInt(goles59.value);
  costaRica.golesContra =
    costaRica.golesContra +
    parseInt(goles49.value) +
    parseInt(goles56.value) +
    parseInt(goles60.value);

  alemania.golesFavor =
    alemania.golesFavor +
    parseInt(goles51.value) +
    parseInt(goles54.value) +
    parseInt(goles60.value);
  alemania.golesContra =
    alemania.golesContra +
    parseInt(goles52.value) +
    parseInt(goles53.value) +
    parseInt(goles59.value);
  ...
  for (let index = 0; index < 4; index++) {
    grupoE[index].diferencia =
      grupoE[index].golesFavor - grupoE[index].golesContra;
  }

  grupoE.sort(function (a, b) {
