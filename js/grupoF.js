...
botonDeCargaF.addEventListener("click", function () {
  ...
  belgica.golesFavor =
    belgica.golesFavor +
    parseInt(goles61.value) +
    parseInt(goles65.value) +
    parseInt(goles69.value);
  belgica.golesContra =
    belgica.golesContra +
    parseInt(goles62.value) +
    parseInt(goles66.value) +
    parseInt(goles70.value);

  canada.golesFavor =
    canada.golesFavor +
    parseInt(goles62.value) +
    parseInt(goles67.value) +
    parseInt(goles71.value);
  canada.golesContra =
    canada.golesContra +
    parseInt(goles61.value) +
    parseInt(goles68.value) +
    parseInt(goles72.value);

  marruecos.golesFavor =
    marruecos.golesFavor +
    parseInt(goles63.value) +
    parseInt(goles66.value) +
    parseInt(goles72.value);
  marruecos.golesContra =
    marruecos.golesContra +
    parseInt(goles64.value) +
    parseInt(goles65.value) +
    parseInt(goles71.value);
  ...
  for (let index = 0; index < 4; index++) {
    grupoF[index].diferencia =
      grupoF[index].golesFavor - grupoF[index].golesContra;
  }

  grupoF.sort(function (a, b) {
