...
botonDeCargaH.addEventListener("click", function () {
  ...
  portugal.golesFavor =
    portugal.golesFavor +
    parseInt(goles85.value) +
    parseInt(goles89.value) +
    parseInt(goles93.value);
  portugal.golesContra =
    portugal.golesContra +
    parseInt(goles86.value) +
    parseInt(goles90.value) +
    parseInt(goles94.value);

  ghana.golesFavor =
    ghana.golesFavor +
    parseInt(goles86.value) +
    parseInt(goles91.value) +
    parseInt(goles95.value);
  ghana.golesContra =
    ghana.golesContra +
    parseInt(goles85.value) +
    parseInt(goles92.value) +
    parseInt(goles96.value);

  uruguay.golesFavor =
    uruguay.golesFavor +
    parseInt(goles87.value) +
    parseInt(goles90.value) +
    parseInt(goles96.value);
  uruguay.golesContra =
    uruguay.golesContra +
    parseInt(goles88.value) +
    parseInt(goles89.value) +
    parseInt(goles95.value);
  ...
  for (let index = 0; index < 4; index++) {
    grupoH[index].diferencia =
      grupoH[index].golesFavor - grupoH[index].golesContra;
  }

  grupoH.sort(function (a, b) {
