...
botonDeCargaB.addEventListener("click", function () {
  ...
  inglaterra.golesFavor =
    inglaterra.golesFavor +
    parseInt(goles13.value) +
    parseInt(goles17.value) +
    parseInt(goles21.value);
  inglaterra.golesContra =
    inglaterra.golesContra +
    parseInt(goles14.value) +
    parseInt(goles18.value) +
    parseInt(goles22.value);

  iran.golesFavor =
    iran.golesFavor +
    parseInt(goles14.value) +
    parseInt(goles19.value) +
    parseInt(goles23.value);
  iran.golesContra =
    iran.golesContra +
    parseInt(goles13.value) +
    parseInt(goles20.value) +
    parseInt(goles24.value);

  eeuu.golesFavor =
    eeuu.golesFavor +
    parseInt(goles15.value) +
    parseInt(goles18.value) +
    parseInt(goles24.value);
  eeuu.golesContra =
    eeuu.golesContra +
    parseInt(goles16.value) +
    parseInt(goles17.value) +
    parseInt(goles23.value);
  ...
  for (let index = 0; index < 4; index++) {
    grupoB[index].diferencia =
      grupoB[index].golesFavor - grupoB[index].golesContra;
  }

  grupoB.sort(function (a, b) {
