...
botonDeCargaC.addEventListener("click", function () {
  ...
  argentina.golesFavor =
    argentina.golesFavor +
    parseInt(goles25.value) +
    parseInt(goles29.value) +
    parseInt(goles33.value);
  argentina.golesContra =
    argentina.golesContra +
    parseInt(goles26.value) +
    parseInt(goles30.value) +
    parseInt(goles34.value);

  arabia.golesFavor =
    arabia.golesFavor +
    parseInt(goles26.value) +
    parseInt(goles31.value) +
    parseInt(goles35.value);
  arabia.golesContra =
    arabia.golesContra +
    parseInt(goles25.value) +
    parseInt(goles32.value) +
    parseInt(goles36.value);

  mexico.golesFavor =
    mexico.golesFavor +
    parseInt(goles27.value) +
    parseInt(goles30.value) +
    parseInt(goles36.value);
  mexico.golesContra =
    mexico.golesContra +
    parseInt(goles28.value) +
    parseInt(goles29.value) +
    parseInt(goles35.value);
  ...
  for (let index = 0; index < 4; index++) {
    grupoC[index].diferencia =
      grupoC[index].golesFavor - grupoC[index].golesContra;
  }

  grupoC.sort(function (a, b) {
