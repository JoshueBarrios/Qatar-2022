...
const guardaPerdedoresSemis = JSON.parse(
  localStorage.getItem("perdedoresSemis")
);
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (localStorage.getItem("ganadoresSemis")) {
    ...
    imagenFinalista1.src =
      "../assets/img/escudos/" + guardaGanadoresSemis[0].id + ".png";
    ...
    imagenFinalista2.src =
      "../assets/img/escudos/" + guardaGanadoresSemis[1].id + ".png";
    ...
    imagenPerdedor1.src =
      "../assets/img/escudos/" + guardaPerdedoresSemis[0].id + ".png";
    ...
    imagenPerdedor2.src =
      "../assets/img/escudos/" + guardaPerdedoresSemis[1].id + ".png";
  }
  ...
  if (localStorage.getItem("ganadoresSemis")) {
    ...
    document.getElementById(`botonFinales`).addEventListener(`click`, () => {
      ...
      img3ro.src =
        "../assets/img/formaciones/" + finalResultados[2].id + ".jpg";
      img2do.src =
        "../assets/img/formaciones/" + finalResultados[1].id + ".jpg";
      img1ro.src =
        "../assets/img/formaciones/" + finalResultados[0].id + ".jpg";
  ...
  function deployGolesFinales() {
    const golesFinalesRecuperados = JSON.parse(
      localStorage.getItem("golesFinales")
    );
