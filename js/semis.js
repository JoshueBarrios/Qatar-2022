...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (localStorage.getItem("ganadores4tos")) {
    ...
    ganadorASimg.src =
      "../assets/img/escudos/" + guardaGanadores4tos[0].id + ".png";
    ...
    ganadorAIimg.src =
      "../assets/img/escudos/" + guardaGanadores4tos[1].id + ".png";
    ...
    ganadorBSimg.src =
      "../assets/img/escudos/" + guardaGanadores4tos[2].id + ".png";
    ...
    ganadorBIimg.src =
      "../assets/img/escudos/" + guardaGanadores4tos[3].id + ".png";
  }
  ...
  function deployGolesSemis() {
    const golesSemisRecuperados = JSON.parse(
      localStorage.getItem("golesSemis")
    );
