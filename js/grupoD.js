...
botonDeCargaD.addEventListener("click", function () {
  ...
  francia.golesFavor =
    francia.golesFavor +
    parseInt(goles37.value) +
    parseInt(goles41.value) +
    parseInt(goles45.value);
  francia.golesContra =
    francia.golesContra +
    parseInt(goles38.value) +
    parseInt(goles42.value) +
    parseInt(goles46.value);

  peru.golesFavor =
    peru.golesFavor +
    parseInt(goles38.value) +
    parseInt(goles43.value) +
    parseInt(goles47.value);
  peru.golesContra =
    peru.golesContra +
    parseInt(goles37.value) +
    parseInt(goles44.value) +
    parseInt(goles48.value);

  dinamarca.golesFavor =
    dinamarca.golesFavor +
    parseInt(goles39.value) +
    parseInt(goles42.value) +
    parseInt(goles48.value);
  dinamarca.golesContra =
    dinamarca.golesContra +
    parseInt(goles40.value) +
    parseInt(goles41.value) +
    parseInt(goles47.value);
  ...
  for (let index = 0; index < 4; index++) {
    grupoD[index].diferencia =
      grupoD[index].golesFavor - grupoD[index].golesContra;
  }

  grupoD.sort(function (a, b) {
