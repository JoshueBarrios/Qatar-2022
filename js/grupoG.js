...
botonDeCargaG.addEventListener("click", function () {
  ...
  brasil.golesFavor =
    brasil.golesFavor +
    parseInt(goles73.value) +
    parseInt(goles77.value) +
    parseInt(goles81.value);
  brasil.golesContra =
    brasil.golesContra +
    parseInt(goles74.value) +
    parseInt(goles78.value) +
    parseInt(goles82.value);

  serbia.golesFavor =
    serbia.golesFavor +
    parseInt(goles74.value) +
    parseInt(goles79.value) +
    parseInt(goles83.value);
  serbia.golesContra =
    serbia.golesContra +
    parseInt(goles73.value) +
    parseInt(goles80.value) +
    parseInt(goles84.value);

  suiza.golesFavor =
    suiza.golesFavor +
    parseInt(goles75.value) +
    parseInt(goles78.value) +
    parseInt(goles84.value);
  suiza.golesContra =
    suiza.golesContra +
    parseInt(goles76.value) +
    parseInt(goles77.value) +
    parseInt(goles83.value);
  ...
  for (let index = 0; index < 4; index++) {
    grupoG[index].diferencia =
      grupoG[index].golesFavor - grupoG[index].golesContra;
  }

  grupoG.sort(function (a, b) {
